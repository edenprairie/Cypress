describe('Login', function () {
    it('Sign in', function () {
        ...
        cy.get('#password').type('Test654321@')
        cy.get('[style="display: flex;justify-content: center; margin-left: -.5em;"] > .nlx-button', {
            timeout: 30000
        }).should('be.visible').click()
        cy.get('.searchHeader > :nth-child(1)').should('be.visible', {
            timeout: 30000
        }).should('contain', 'WorkBox Items')
